...
{
    float iSum = 0;                         // to store the resulet   
  
    if(iNo1 < 0.0f)                          // updater
    {
        iNo1  = -iNo1;
    }     
    
    if(iNo2<0.0f)                            // updater
    {
        iNo2 =- iNo2;
    }
...
int main()
{
    float iValue1 = 0.0f, iValue2 = 0.0f;        // to accept user input    
    ...
    fRet = AdditionTwoNumbers(iValue1,iValue2);  // function call
...
//
//   Input 1 : 10.0        Input2 : 3.0          output : 13
//   Input 1 : -10.0       Input2 : 3.0          output : 13
//   Input 1 : 10.0        Input2 : -3.0         output : 13
//   Input 1 : -10.0       Input2 : -3.0         output : 13
//
